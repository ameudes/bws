...
if 'list_user' not in st.session_state:
    ...
    update_subsetgroup(selected)  # Mise à jour du fichier : suppression de cet indice de remaining
...
# Utilisation de la séquence sélectionnée
...
if not st.session_state.start:
    st.title("Bienvenue")
    st.write("""
        Nous vous invitons à partager votre opinion sur l'utilisation des données ouvertes dans le cadre de la participation citoyenne.
        
        Ce questionnaire vous demande de choisir, pour chaque groupe de caractéristiques liées aux données, l’aspect le  **plus important** et le **moins important** selon vous.
